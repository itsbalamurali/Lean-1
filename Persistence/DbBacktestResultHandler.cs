...
using QuantConnect.Persistence.Models;

namespace QuantConnect.Persistence
{
    public class DbBacktestResultHandler : BaseResultsHandler, IResultHandler
    {
        ...
        private LeanDbContext _dbContext;

        /// <summary>
        /// Creates a new instance
        /// </summary>
        public DbBacktestResultHandler()
        {
