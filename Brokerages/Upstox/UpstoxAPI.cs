...
namespace QuantConnect.Brokerages.Upstox
{
    ...
    public class UpstoxAPI
    {
        ...
        /// <summary>
        /// Initialize a new UpstoxAPI Connect client instance.
        /// </summary>
        ...
        /// to the UpstoxAPI Connect class initialisation for subsequent requests.</param>
        ...
        public UpstoxAPI(string APIKey, string AccessToken = null, string Root = null, int Timeout = 7000, WebProxy Proxy = null, int Pool = 2)
        {
        ...
        public List<Instrument> GetInstruments(string Exchange = null)
        {
            ...
            try
            {
                ...
                var latestFile = Globals.DataFolder+"UpstoxInstrument-" + DateTime.Now.Date.ToString("dd/MM/yyyy",CultureInfo.InvariantCulture).Replace(" ", "-").Replace("/", "-") + ".csv";
        ...
        {
            var UpstoxAPIAssembly = System.Reflection.Assembly.GetAssembly(typeof(UpstoxAPI));
            if (UpstoxAPIAssembly != null)
                Req.UserAgent = "UpstoxAPIConnect.Net/" + UpstoxAPIAssembly.GetName().Version;

            Req.Headers.Add("X-UpstoxAPI-Version", "3");
