...
namespace QuantConnect.Brokerages.Exante.Model
{
    ...
    public partial class WsTrade : IEquatable<WsTrade>, IValidatableObject
    {
        ...
        public WsTrade(string time = default(string), string price = default(string), string timestamp = default(string), EventEnum _event = default(EventEnum), string quantity = default(string), Guid orderId = default(Guid), long sequenceNumber = default(long), string position = default(string))
        {
            ...
            this.Time = time ?? throw new ArgumentNullException("time is a required property for WsTrade and cannot be null");
            // to ensure "price" is required (not null)
            this.Price = price ?? throw new ArgumentNullException("price is a required property for WsTrade and cannot be null");
            // to ensure "timestamp" is required (not null)
            this.Timestamp = timestamp ?? throw new ArgumentNullException("timestamp is a required property for WsTrade and cannot be null");
            this.Event = _event;
            // to ensure "quantity" is required (not null)
            this.Quantity = quantity ?? throw new ArgumentNullException("quantity is a required property for WsTrade and cannot be null");
            this.OrderId = orderId;
            this.SequenceNumber = sequenceNumber;
            // to ensure "position" is required (not null)
            this.Position = position ?? throw new ArgumentNullException("position is a required property for WsTrade and cannot be null");
        }
