...
namespace QuantConnect.Brokerages.Kraken
{
    ...
    /// </summary>
    public class KrakenOrderSubmitEventArgs
    {
        /// <summary>
        /// Order Event Constructor.
        /// </summary>
        /// <param name="brokerId">Kraken order id returned from brokerage</param>
        /// <param name="order">Order for this order placement</param>
        public KrakenOrderSubmitEventArgs(string brokerId, Order order)
        {
            BrokerId = brokerId;
            Order = order;
        }
