...
using QuantConnect.Brokerages.Kraken.Messages;
        ...
        private void OnMessageImpl(WebSocketMessage e)
        {
            try
            {
                ...
                if (objEventType != null)
                {
                    ...
                    switch (eventType)
                    {
                        ...
                        case "trade":
                            ...
                            EmitTradeTick(
                                _symbolMapper.GetLeanSymbol(trade.Symbol, SecurityType.Crypto, Market.Kraken),
                ...
                else if (objData["u"] != null)
                {
                    ...
                    EmitQuoteTick(
                        _symbolMapper.GetLeanSymbol(quote.Symbol, SecurityType.Crypto, Market.Kraken),
                        quote.BestBidPrice,
                        quote.BestBidSize,
                        quote.BestAskPrice,
                        quote.BestAskSize);
        ...
        private void OnFillOrder(Execution data)
        {
            try
            {
                ...
                (
                    ...
                    orderFee, $"Kraken Order Event {data.Direction}"
                );
